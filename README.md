...
젠킨스는 localhost로 실행되기 때문에 깃허브 레포 변화에 따른 build를 재생성하려면 깃허브가 젠킨스가 띄어진 로컬에 알림을 보내고 젠킨스는 깃허브의 뉴코드를 받을 수 있어야한다
...
![제목 없음](https://github.com/ugyeong0u0/Fisa_CI/assets/120684605/4fd675c3-5df1-44ba-a472-5201f91a7cec)
